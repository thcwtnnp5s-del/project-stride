...
| `world/atlas_south.png`, `world/marker_{haven,wilds,worksite,perilous,landmark}.png` | 384 × 688; 20 × 20 | ×2 on the atlas | `WORLD_REWARD_DEPTH_01/world/out/world/`. The south tile joins the base below it (world 768 × 2752); the east / south-east tiles, four landmark cutouts and their props are **withheld** after two blind QA FAILs on seam continuity (`QA_VERDICT_ROUND1.md`, `MISTAKES.md` M-12) |
