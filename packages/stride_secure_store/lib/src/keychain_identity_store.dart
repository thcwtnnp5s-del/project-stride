...
///
/// **`ThisDeviceOnly` is the whole control.** Items with a `ThisDeviceOnly`
/// accessibility are excluded from encrypted backups and are not restored to a
/// different device, so a restored phone finds the save present and the
/// identity missing — which is the refusal.
///
